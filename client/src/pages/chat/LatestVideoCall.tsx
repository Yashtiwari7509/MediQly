    ...
    <MainLayout>
      <div className="container mx-auto animate-in">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-bold">Chat with Doctors</h1>
          {selectedDoctor && (
        ...
        <div className="grid gap-6 md:grid-cols-[300px_1fr]">
          ...
          <div className={`${selectedDoctor ? "hidden md:block" : "block"}`}>
          ...
          {/* Chat Interface - Full width on mobile when doctor is selected */}
          <div className={`${!selectedDoctor ? "hidden md:block" : "block"}`}>
            <Card className="h-[calc(100vh-200px)]">
              {selectedDoctor ? (
                <>
